...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;
    }
.end annotation
...
.method private static parseAudioSampleEntry(Lcom/google/android/exoplayer/util/ParsableByteArray;IIIJLcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;I)V
    .locals 12
    ...
    invoke-static {v4, v11}, Lcom/google/android/exoplayer/util/Assertions;->checkArgument(ZLjava/lang/Object;)V
    ...
    .line 559
    sget v11, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_mp4a:I

    if-eq p1, v11, :cond_1

    sget v11, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_enca:I

    if-ne p1, v11, :cond_7

    .line 560
    :cond_1
    sget v11, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_esds:I
    ...
    .line 568
    invoke-static {v5}, Lcom/google/android/exoplayer/util/CodecSpecificDataUtil;->parseAacAudioSpecificConfig([B)Landroid/util/Pair;
    ...
    .line 573
    :cond_6
    sget v11, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_sinf:I
    ...
    iget-object v4, v0, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;->trackEncryptionBoxes:[Lcom/google/android/exoplayer/extractor/mp4/TrackEncryptionBox;

    invoke-static {p0, v9, v10}, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers;->parseSinfFromParent(Lcom/google/android/exoplayer/util/ParsableByteArray;II)Lcom/google/android/exoplayer/extractor/mp4/TrackEncryptionBox;
    ...
    .line 577
    :cond_7
    sget v11, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_ac_3:I

    if-ne p1, v11, :cond_9

    sget v11, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_dac3:I
    ...
    .line 581
    invoke-static {p0}, Lcom/google/android/exoplayer/util/Ac3Util;->parseAnnexFAc3Format(Lcom/google/android/exoplayer/util/ParsableByteArray;)Lcom/google/android/exoplayer/MediaFormat;

    move-result-object v2

    move-object/from16 v0, p6

    iput-object v2, v0, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;->mediaFormat:Lcom/google/android/exoplayer/MediaFormat;
    ...
    .line 583
    :cond_9
    sget v11, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_ec_3:I

    if-ne p1, v11, :cond_3

    sget v11, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_dec3:I
    ...
    .line 585
    invoke-static {p0}, Lcom/google/android/exoplayer/util/Ac3Util;->parseAnnexFEAc3Format(Lcom/google/android/exoplayer/util/ParsableByteArray;)Lcom/google/android/exoplayer/MediaFormat;
    ...
    invoke-static/range {v2 .. v8}, Lcom/google/android/exoplayer/MediaFormat;->createAudioFormat(Ljava/lang/String;IJIILjava/util/List;)Lcom/google/android/exoplayer/MediaFormat;
...
.method private static parseAvcCFromParent(Lcom/google/android/exoplayer/util/ParsableByteArray;I)Landroid/util/Pair;
    .locals 6
...
.method private static parseSinfFromParent(Lcom/google/android/exoplayer/util/ParsableByteArray;II)Lcom/google/android/exoplayer/extractor/mp4/TrackEncryptionBox;
    ...
    .line 498
    invoke-static {p0, v1, v2}, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers;->parseSchiFromParent(Lcom/google/android/exoplayer/util/ParsableByteArray;II)Lcom/google/android/exoplayer/extractor/mp4/TrackEncryptionBox;
...
.method public static parseStbl(Lcom/google/android/exoplayer/extractor/mp4/Track;Lcom/google/android/exoplayer/extractor/mp4/Atom$ContainerAtom;)Lcom/google/android/exoplayer/extractor/mp4/TrackSampleTable;
    ...
    .line 91
    sget v5, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_stsc:I
    ...
    .line 93
    sget v5, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_stts:I
    ...
    .line 95
    sget v5, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_stss:I
    ...
    .line 98
    :goto_0
    sget v6, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_ctts:I

    move-object/from16 v0, p1

    invoke-virtual {v0, v6}, Lcom/google/android/exoplayer/extractor/mp4/Atom$ContainerAtom;->getLeafAtomOfType(I)Lcom/google/android/exoplayer/extractor/mp4/Atom$LeafAtom;
    ...
    .line 103
    invoke-virtual/range {v29 .. v29}, Lcom/google/android/exoplayer/util/ParsableByteArray;->readUnsignedIntToInt()I
    ...
    .line 164
    :cond_6
    iget v10, v4, Lcom/google/android/exoplayer/extractor/mp4/Atom$LeafAtom;->type:I

    sget v11, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_stco:I

    if-ne v10, v11, :cond_a

    .line 165
    invoke-virtual/range {v30 .. v30}, Lcom/google/android/exoplayer/util/ParsableByteArray;->readUnsignedInt()J
    ...
    .line 211
    iget v7, v4, Lcom/google/android/exoplayer/extractor/mp4/Atom$LeafAtom;->type:I

    sget v8, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_stco:I
    ...
    invoke-virtual {v0, v14}, Lcom/google/android/exoplayer/util/ParsableByteArray;->skipBytes(I)V
    ...
    .line 167
    :cond_a
    invoke-virtual/range {v30 .. v30}, Lcom/google/android/exoplayer/util/ParsableByteArray;->readUnsignedLongToLong()J
...
.method private static parseStsd(Lcom/google/android/exoplayer/util/ParsableByteArray;J)Lcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;
    .locals 11
    ...
    .line 341
    invoke-static/range {v1 .. v7}, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers;->parseVideoSampleEntry(Lcom/google/android/exoplayer/util/ParsableByteArray;IIJLcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;I)V
    ...
    .line 344
    invoke-static/range {v0 .. v7}, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers;->parseAudioSampleEntry(Lcom/google/android/exoplayer/util/ParsableByteArray;IIIJLcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;I)V
    ...
    invoke-static {v0, p1, p2}, Lcom/google/android/exoplayer/MediaFormat;->createTextFormat(Ljava/lang/String;J)Lcom/google/android/exoplayer/MediaFormat;

    move-result-object v0

    iput-object v0, v6, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;->mediaFormat:Lcom/google/android/exoplayer/MediaFormat;
...
.method public static parseTrak(Lcom/google/android/exoplayer/extractor/mp4/Atom$ContainerAtom;Lcom/google/android/exoplayer/extractor/mp4/Atom$LeafAtom;)Lcom/google/android/exoplayer/extractor/mp4/Track;
    .locals 13
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/exoplayer/extractor/mp4/Atom$ContainerAtom;->getContainerAtomOfType(I)Lcom/google/android/exoplayer/extractor/mp4/Atom$ContainerAtom;
    ...
    invoke-virtual {v9, v0}, Lcom/google/android/exoplayer/extractor/mp4/Atom$ContainerAtom;->getLeafAtomOfType(I)Lcom/google/android/exoplayer/extractor/mp4/Atom$LeafAtom;
    ...
    invoke-static {v0}, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers;->parseHdlr(Lcom/google/android/exoplayer/util/ParsableByteArray;)I

    move-result v11

    .line 47
    sget v0, Lcom/google/android/exoplayer/extractor/mp4/Track;->TYPE_AUDIO:I

    if-eq v11, v0, :cond_0

    sget v0, Lcom/google/android/exoplayer/extractor/mp4/Track;->TYPE_VIDEO:I

    if-eq v11, v0, :cond_0

    sget v0, Lcom/google/android/exoplayer/extractor/mp4/Track;->TYPE_TEXT:I

    if-eq v11, v0, :cond_0

    sget v0, Lcom/google/android/exoplayer/extractor/mp4/Track;->TYPE_SUBTITLE:I
    ...
    invoke-static {v0}, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers;->parseTkhd(Lcom/google/android/exoplayer/util/ParsableByteArray;)Landroid/util/Pair;
    ...
    .line 55
    iget-object v2, p1, Lcom/google/android/exoplayer/extractor/mp4/Atom$LeafAtom;->data:Lcom/google/android/exoplayer/util/ParsableByteArray;
    ...
    invoke-virtual {v9, v0}, Lcom/google/android/exoplayer/extractor/mp4/Atom$ContainerAtom;->getContainerAtomOfType(I)Lcom/google/android/exoplayer/extractor/mp4/Atom$ContainerAtom;

    move-result-object v0

    sget v1, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_stbl:I
    ...
    .line 65
    sget v1, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_mdhd:I

    invoke-virtual {v9, v1}, Lcom/google/android/exoplayer/extractor/mp4/Atom$ContainerAtom;->getLeafAtomOfType(I)Lcom/google/android/exoplayer/extractor/mp4/Atom$LeafAtom;
    ...
    invoke-static {v1}, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers;->parseMdhd(Lcom/google/android/exoplayer/util/ParsableByteArray;)J

    move-result-wide v4

    .line 66
    sget v1, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_stsd:I
    ...
    invoke-static {v0, v6, v7}, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers;->parseStsd(Lcom/google/android/exoplayer/util/ParsableByteArray;J)Lcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;

    move-result-object v0

    .line 67
    iget-object v1, v0, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;->mediaFormat:Lcom/google/android/exoplayer/MediaFormat;
    ...
    iget-object v8, v0, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;->mediaFormat:Lcom/google/android/exoplayer/MediaFormat;

    iget-object v9, v0, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;->trackEncryptionBoxes:[Lcom/google/android/exoplayer/extractor/mp4/TrackEncryptionBox;

    iget v10, v0, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;->nalUnitLengthFieldLength:I
...
.method private static parseVideoSampleEntry(Lcom/google/android/exoplayer/util/ParsableByteArray;IIJLcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;I)V
    .locals 13
    ...
    .line 379
    sget v4, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_avcC:I
    ...
    .line 382
    invoke-static {p0, v10}, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers;->parseAvcCFromParent(Lcom/google/android/exoplayer/util/ParsableByteArray;I)Landroid/util/Pair;
    ...
    iput v2, v0, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;->nalUnitLengthFieldLength:I
    ...
    .line 385
    :cond_5
    sget v4, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_hvcC:I
    ...
    .line 388
    invoke-static {p0, v10}, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers;->parseHvcCFromParent(Lcom/google/android/exoplayer/util/ParsableByteArray;I)Landroid/util/Pair;
    ...
    .line 391
    :cond_7
    sget v4, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_d263:I
    ...
    .line 396
    invoke-static {p0, v10}, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers;->parseEsdsFromParent(Lcom/google/android/exoplayer/util/ParsableByteArray;I)Landroid/util/Pair;
    ...
    iget-object v3, v0, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers$StsdDataHolder;->trackEncryptionBoxes:[Lcom/google/android/exoplayer/extractor/mp4/TrackEncryptionBox;

    invoke-static {p0, v10, v11}, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers;->parseSinfFromParent(Lcom/google/android/exoplayer/util/ParsableByteArray;II)Lcom/google/android/exoplayer/extractor/mp4/TrackEncryptionBox;
    ...
    .line 403
    :cond_c
    sget v4, Lcom/google/android/exoplayer/extractor/mp4/Atom;->TYPE_pasp:I

    if-ne v3, v4, :cond_2

    .line 404
    invoke-static {p0, v10}, Lcom/google/android/exoplayer/extractor/mp4/AtomParsers;->parsePaspFromParent(Lcom/google/android/exoplayer/util/ParsableByteArray;I)F

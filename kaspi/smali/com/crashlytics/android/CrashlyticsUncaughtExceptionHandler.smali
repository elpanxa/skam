...
.method private doCloseSessions()V
    ...
    invoke-virtual {v0}, Lcom/crashlytics/android/Crashlytics;->getSessionSettingsData()Lio/fabric/sdk/android/services/settings/SessionSettingsData;
    ...
    .line 570
    iget v1, v0, Lio/fabric/sdk/android/services/settings/SessionSettingsData;->maxCustomExceptionEvents:I
...
.method private doOpenSession()V
    ...
    iget-object v2, p0, Lcom/crashlytics/android/CrashlyticsUncaughtExceptionHandler;->idManager:Lio/fabric/sdk/android/services/common/IdManager;

    invoke-direct {v1, v2}, Lcom/crashlytics/android/CLSUUID;-><init>(Lio/fabric/sdk/android/services/common/IdManager;)V
...
.method private writeFatal(Ljava/util/Date;Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    invoke-static {v7, v1}, Lio/fabric/sdk/android/services/common/CommonUtils;->closeOrLog(Ljava/io/Closeable;Ljava/lang/String;)V
...
.method private writeSessionDevice(Ljava/lang/String;)V
    ...
    iget-object v6, v0, Lcom/crashlytics/android/CrashlyticsUncaughtExceptionHandler;->idManager:Lio/fabric/sdk/android/services/common/IdManager;
...
.method private writeSessionEvent(Lcom/crashlytics/android/CodedOutputStream;Ljava/util/Date;Ljava/lang/Thread;Ljava/lang/Throwable;Ljava/lang/String;Z)V
    ...
    invoke-static {v7, v2, v3}, Lio/fabric/sdk/android/services/common/CommonUtils;->getBooleanResourceValue(Landroid/content/Context;Ljava/lang/String;Z)Z
...
.method private writeSessionPartsToSessionFile(Ljava/io/File;Ljava/lang/String;I)V
    ...
    invoke-interface {v0, v3, v5}, Lio/fabric/sdk/android/Logger;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v3, v5, v7}, Lio/fabric/sdk/android/Logger;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v7, v8, v1}, Lio/fabric/sdk/android/Logger;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v4, v7, v8}, Lio/fabric/sdk/android/Logger;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v2, v3, v5, v0}, Lio/fabric/sdk/android/Logger;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
